                                ...
                                <table class="table table-bordered" id="mauexport" width="100%" cellspacing="0">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td> 
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit<?=$iduser;?>">
                                                Edit
                                                </button>
                                                <input type="hidden" name="idbarangygmaudihapus" value="<?=$iduser;?>">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted"> &copy; Stok Barang</div>
                            <div>
